...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('hpermissions/{id}',  [HPermissionController::class, 'getPermission'])->name('get.permission')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::post('hpermission/changeaction',  [HPermissionController::class, 'changeaction'])->name('changeaction.permission')->middleware(
        [
            'auth',
            'XSS',
        ]
