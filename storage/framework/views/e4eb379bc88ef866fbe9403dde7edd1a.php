                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            <?php if(\Auth::user()->type == 'employee'): ?>
                                                <?php echo Form::hidden('employee', !empty($employeesList) ? \Auth::user()->employee->id : 0, ['id' => 'employee_id']); ?>

                                            <?php else: ?>
                                                <?php echo e(Form::label('employee', __('Employee'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::select('employee', $employeesList, isset($_GET['employee']) ? $_GET['employee'] : '', [
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dsimi.org\resources\views/timeSheet/index.blade.php ENDPATH**/ ?>