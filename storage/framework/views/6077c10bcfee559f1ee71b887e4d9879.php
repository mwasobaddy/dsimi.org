...
<div class="navbar-wrapper">
    <div class="m-header main-logo">
        <a href="<?php echo e(route('dashboard')); ?>" class="b-brand">
            ...
            <img src="<?php echo e($logo . (isset($company_logo) && !empty($company_logo) ? $company_logo . '?' . time() : 'logo-dark.png' . '?' . time())); ?>"
                alt="<?php echo e(config('app.name', 'HRMGo')); ?>" class="logo logo-lg" style="height: 100px;">
        </a>
    </div>
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            <?php if(Gate::check('Manage Awards') ||
                ...
                <li
                    ...
                    <a href="#!" class="dash-link">
                        ...
                        <span class="dash-mtext"><?php echo e(__('Mes dossiers RH')); ?></span>
            ...
            <!-- performance-->
            <?php if(Gate::check('Manage Indicator') || Gate::check('Manage Appraisal') || Gate::check('Manage Goal Tracking') || Gate::check('Show Indicator') || Gate::check('Show Appraisal')): ?>
                <li class="dash-item dash-hasmenu">
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                    ...
                    <ul class="dash-submenu">
                        ...
                        <?php if(\Auth::user()->type != 'company' && \Auth::user()->type != 'super admin' && \Auth::user()->type != 'Administrator (Employee)'): ?>
            ...
            <!-- HR-->
             <?php if((Gate::check('Manage Awards') ||
                ...
                <li
                    ...
                    <ul class="dash-submenu">
                        <li class="dash-item <?php echo e(Request::segment(1) == 'award' ? 'active' : ''); ?>">
                            <a class="dash-link" href="<?php echo e(route('award.index')); ?>"><?php echo e(__('Prime')); ?></a>
                        </li>
                        <li class="dash-item">
                            <a class="dash-link" href="<?php echo e(route('transfer.index')); ?>"><?php echo e(__('Transfer')); ?></a>
                        </li>
...
<?php /**PATH /home/earljoe/Documents/freelance/Assignment 1/segmented/updated/dsimi.org/resources/views/partial/Admin/menu.blade.php ENDPATH**/ ?>