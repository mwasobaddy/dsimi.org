                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $meetings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meeting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(\Carbon\Carbon::parse($meeting->date)->locale('fr')->isoFormat('LL')); ?></td>

                                    <td><?php echo e(\Carbon\Carbon::parse($meeting->time)->locale('fr')->format('H:i')); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/earljoe/Documents/freelance/Assignment 1/segmented/dsimi.org (copy)/resources/views/meeting/index.blade.php ENDPATH**/ ?>