...
<?php if(Auth::user()->type == 'company' || Auth::user()->type == 'hr' || strtolower(Auth::user()->type) == 'super admin'): ?>
...
<?php /**PATH /home/u526107821/domains/dsimi.org/public_html/resources/views/leave/action.blade.php ENDPATH**/ ?>