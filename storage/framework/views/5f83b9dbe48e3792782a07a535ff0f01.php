                        ...
                        <table class="table" id="pc-dt-simple">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <?php if(\Auth::user()->type != 'employee'): ?>
                                            <td><?php echo e(!empty($leave->employee_id) && !empty($leave->employees) ? $leave->employees->first_name . ' ' . $leave->employees->last_name : ''); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/earljoe/Documents/freelance/Assignment 1/segmented/dsimi.org (copy)/resources/views/leave/index.blade.php ENDPATH**/ ?>