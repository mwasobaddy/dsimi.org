...
<div class="header-container">
    ...
    <div class="content" style="margin-left: 40px;">
        Madame : <?php echo e($leave->employee_name); ?><br>
        Matricule : <?php echo e($leave->employee_id); ?><br>
        Emploi : <?php echo e($leave->employee_position); ?><br>
        <!-- Grade : <?php echo e($leave->employee_); ?><br> -->
        Service : DSIMI<br>
    </div>

    <div class="content">
        A effectivement repris fonction le <?php echo e(\Carbon\Carbon::parse($leave->end_date)->addDays(1)->format('d/m/Y')); ?>
    ...
    <div class="content">
        ...
        au <?php echo e(\Carbon\Carbon::parse($leave->end_date)->format('d/m/Y')); ?> inclus.
    </div>
...
<?php /**PATH /home/earljoe/Documents/freelance/Assignment 1/segmented/dsimi.org (copy)/resources/views/certificates/leave_maternity.blade.php ENDPATH**/ ?>