    ...
    <div class="m-header main-logo">
        <a href="{{ route('dashboard') }}" class="b-brand">
            ...
            <img src="{{ $logo . (isset($company_logo) && !empty($company_logo) ? $company_logo . '?' . time() : 'logo-dark.png' . '?' . time()) }}"
                alt="{{ config('app.name', 'HRMGo') }}" class="logo logo-lg" style="height: 100px;">
        </a>
    </div>
            ...
            @if (Gate::check('Manage Awards') ||
                ...
                <li
                    ...
                    <a href="#!" class="dash-link">
                        ...
                        <span class="dash-mtext">{{ __('Mes dossiers RH') }}</span>
            ...
            @if (Gate::check('Manage Attendance') || Gate::check('Manage Leave') || Gate::check('Manage TimeSheet'))
                <li
                    ...
                    <ul class="dash-submenu">
                        ...
                        @endcan
                        @can('Hourly Permission Requests')
                        <li class="dash-item">
                            <a class="dash-link" href="{{ route('permissions.index') }}">{{ __('Hourly Permission Requests') }}</a>
                        </li>
                    @endcan
            ...
            <!-- HR-->
             @if ((Gate::check('Manage Awards') ||
                ...
                <li
                    ...
                    <ul class="dash-submenu">
                        <li class="dash-item {{ Request::segment(1) == 'award' ? 'active' : '' }}">
                            <a class="dash-link" href="{{ route('award.index') }}">{{ __('Prime') }}</a>
                        </li>
                        <li class="dash-item">
                            <a class="dash-link" href="{{ route('transfer.index') }}">{{ __('Transfer') }}</a>
                        </li>
