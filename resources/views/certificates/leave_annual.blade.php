...
<body>
    ...
    <div class="content">
        ...
        {{ $leave->employee_name }}, matricule {{ $leave->employee_id }}, 
        emploi {{ $leave->employee_position }} à ladite Direction, bénéficiaire de son 
        congé annuel de {{ $leave->total_leave_days }} jours au titre de l'année {{ date('Y') }}, 
